---
title: "Burnout"
description: "Recognising when screen time is costing more than it's earning."
section: "Psychology"
section_slug: "psychology"
order: 8
weight: 8
status: "published"
tags: ["psychology", "burnout", "trading routine"]
related: ["building-a-trading-routine", "overtrading", "consistency"]
---

Burnout in trading isn't just tiredness from a long session, it's the point where more screen time is costing more than it's earning, and recognising that line is harder than it sounds because trading doesn't feel like manual work while it's draining you.

---

## Why trading burns you out differently

Most jobs that cause burnout do it through sustained effort over long hours. Trading adds something else on top: constant, low-level uncertainty and real financial consequence attached to decisions made under time pressure, often for hours at a stretch with no natural break built into the structure of the day. That combination taxes the same judgement a trader depends on to do the job well, so unlike burnout in many other roles, trading burnout directly damages the very skill the work requires, not just the enthusiasm for doing it.
...
Pushing through with more hours or more discipline usually makes this worse, because the problem isn't a lack of effort, it's that the current level of effort has stopped producing good decisions. The fix tends to be structural, not willpower-based: fixed session hours instead of open-ended screen time, real breaks away from the charts instead of a five-minute scroll on a different tab, and treating a string of below-standard sessions as a signal to step back for a day, not a reason to trade longer to make up for it.
