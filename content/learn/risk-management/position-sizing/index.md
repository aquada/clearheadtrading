...
description: "How to size a position from your stop distance and account risk, not a gut feeling."
section: "Risk Management"
section_slug: "risk-management"
order: 1
weight: 1
status: "published"
tags: ["risk management", "position sizing", "lot size"]
related: ["stop-loss-placement", "risk-to-reward-ratio", "daily-loss-limits"]
---
...
{{< figure src="position-sizing.png" caption="All three trades risk the same $100. The tighter the stop, the bigger the position needed to reach that number, and the wider the stop, the smaller." >}}
