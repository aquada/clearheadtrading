---
title: "Prop Firm Risk Rules"
description: "How daily loss, max drawdown, and profit target rules interact, and where traders get caught out."
section: "Risk Management"
section_slug: "risk-management"
order: 6
weight: 6
status: "published"
tags: ["risk management", "prop firms", "evaluation"]
related: ["daily-loss-limits", "risk-to-reward-ratio", "position-sizing"]
---
...
Most prop firm evaluations combine a daily loss limit, a hard cap on losses within a single day, usually 4-5% of account size, a maximum overall drawdown, a hard cap on total loss from either the starting balance or the account's peak, commonly 8-10%, and a profit target, a required gain, often 8-10% for the first phase and sometimes lower for a second one, to pass. Every firm sets its own numbers, but that basic shape, daily limit, max drawdown, profit target, is close to universal across the industry. Compare rules across specific firms on the [prop firms comparison tool](/prop-firms/compare/).
